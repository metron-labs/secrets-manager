...
export class GCPKeyValueStorage implements KeyValueStorage {
  ...
  async getKeyDetails() {
    try {
      ...
      // google.cloud.kms.v1.CryptoKey.CryptoKeyPurpose | "CRYPTO_KEY_PURPOSE_UNSPECIFIED" | "ENCRYPT_DECRYPT" | "ASYMMETRIC_SIGN" | "ASYMMETRIC_DECRYPT" | "RAW_ENCRYPT_DECRYPT" | "MAC"
